...
Studies used the equilibrium state to calculate the parameters, \improvement{TODO: added reference} and to explore the optimal interventions coverage of \gls{llins}.
